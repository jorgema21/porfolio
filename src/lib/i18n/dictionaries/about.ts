export const about = {
  es: {
    title: "Sobre mí",
    intro:
      "Soy periodista y diseñador especializado en visualización de datos e infografía.",
    focus:
  ...
  en: {
    title: "About me",
    intro:
      "I’m a journalist and designer specializing in data visualization and infographics.",
    focus:
