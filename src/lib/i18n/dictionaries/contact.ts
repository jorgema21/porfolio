export const contact = {
  es: {
    title: "Hablemos",
    text: "Estoy disponible para nuevas colaboraciones, trabajos de visualización de datos y redacción de reportajes de estilo de vida y maternidad.",

    subtitle: "¿Tienes una historia en mente?",
    description:
  ...
  en: {
    title: "Let's Talk",
    text: "I am available for new collaborations, data visualization projects, and feature writing on lifestyle and parenting.",

    subtitle: "Have a story in mind?",
    description:
